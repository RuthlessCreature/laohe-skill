...
- 代码体积控制（同 QualityAGENTS 编码原则）：文件/类预警 300 行、强制拆分 400 行，函数预警 40 行、强制拆分 60 行。例外：生成代码、大型测试夹具、迁移脚本、协议常量表
...
- [ ] 依赖方向正确（外 → 内）
- [ ] 变更范围可控
- [ ] 技术选型符合 QualityAGENTS 技术下限；若当前模式未加载质量下限章节，则至少满足技术选型原则且新项目无过时依赖
